...
class TarantulaTest < ActionController::IntegrationTest
  ...
  def test_tarantula
    ...
    # 
    post '/session', :session=>{:email => 'aaron@example.com', :password => '123456'}
    assert_response 200
    t = tarantula_crawler(self)
    t.crawl '/global_dashboard'
    t.crawl '/projects/1/dashboard'
    t.crawl "/projects/1/posts"
    t.crawl "/projects/2/posts"
    t.crawl "/projects/50/posts"
  end
end
