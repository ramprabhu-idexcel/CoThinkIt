    ...
    def page_link_or_span(page, span_class, text = nil)
      text ||= page.to_s
       if page and page != current_page
        ...
        val= text.include?("Previous") 
        valnext=text.include?("Next")
        if val 
            page_span page, text, :class => span_class, :style=>"padding-right:10px;"
        elsif valnext
          page_span page, text, :class => span_class, :style=>"padding-left:10px;"
        else
          page_span page, text, :class => span_class, :style=>"background:url('/images/admin_images/bg-button-green.gif') repeat-x scroll left top #469400 !important;border-color:#459300 !important;color:#FFFFFF !important;border:1px solid #DDDDDD;margin:0 5px 0 0;padding:3px 6px;-moz-border-radius:4px 4px 4px 4px;"
        end
      end
    end
