...
HiddenInput = Class.create({
 ...
 Token = Class.create({
    ...
    detect: function(e) {
        ...
        add_user(b.childNodes[1].innerHTML);
...
addContactToList = function(item) {
	...
	contacts[Element.readAttribute(item,'value')].name,
        ...
        onclick:"remove_user(this.parentNode.parentNode.parentNode.parentNode.parentNode);this.parentNode.parentNode.parentNode.parentNode.parentNode.remove(true); return false;"}," ")
        ]
    )
    )
    )   
