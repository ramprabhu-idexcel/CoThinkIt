...
create_table :countries do |t|
		t.column :country_name, :string,:size=>8
t.timestamps
		end
...
Country.create(:country_name=> '  British Indian Ocean Territory '  )
...
Country.create(:country_name=> '  CapeVerde '  )
...
Country.create(:country_name=> '  Christmas Island '  )
Country.create(:country_name=> '  Cocos (Keeling) Islands '  )
Country.create(:country_name=> '  Colombia '  )
Country.create(:country_name=> '  Comoros '  )
Country.create(:country_name=> '  Congo '  )
Country.create(:country_name=> '  Congo,the Democratic Republic of the '  )
...
Country.create(:country_name=> '  ElSalvador '  )
...
Country.create(:country_name=> '  Holysee(Vatican City State) '  )
Country.create(:country_name=> '  Honduras '  )
Country.create(:country_name=> '  HongKong '  )
...
Country.create(:country_name=> '  IranIslamicRepublicof '  )
...
Country.create(:country_name=> '  Korea Democratic People\'s Republicof '  )
Country.create(:country_name=> '  Korea Republic of '  )
...
Country.create(:country_name=> '  Macedonia the Former Yugoslav Republic of '  )
...
Country.create(:country_name=> '  Moldova, Republic of '  )
...
Country.create(:country_name=> '  South Georgia and The South Sandwich Islands '  )
Country.create(:country_name=> '  SriLanka '  )
...
Country.create(:country_name=> '  Tanzania United Republic of '  )
Country.create(:country_name=> '  Thailand '  )
Country.create(:country_name=> '  Timor-leste '  )
...
Country.create(:country_name=> '  United States Minor Outlying Islands'  )
